...
updateSearchTag(evt){
 ...
 <Final finalquery={this.state.finalquery} pageSize={this.state.pageSize} handlePageSizeChange={this.handlePageSizeChange.bind(this)} />
...
render(){
  return(
    <div>
      ...
      <input type="text" placeholder="Enter query term" size='40px' name="finalquery" onChange = {this.updatefinalquery} />
      &nbsp;&nbsp;&nbsp;
...
//<input type="text" placeholder="Enter PageSize .." size='20px' name='pageSize' onChange = {this.handlePageSizeChange} />
}
